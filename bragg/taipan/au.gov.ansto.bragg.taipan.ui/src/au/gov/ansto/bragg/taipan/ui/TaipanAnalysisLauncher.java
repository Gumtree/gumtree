...
public class TaipanAnalysisLauncher extends AbstractLauncher {
	...
	private static Logger logger = LoggerFactory.getLogger(TaipanAnalysisLauncher.class);
...
//			mmManager.showPerspectiveOnOpenedWindow(ID_PERSPECTIVE_EXPERIMENT, 0, 0, mmManager.isMultiMonitorSystem());
			...
			if (isBfMode) {
				mmManager.showPerspectiveOnOpenedWindow(BFAnalysisPerspective.ID_PERSPECTIVE_BFANALYSIS, 0, 0, mmManager.isMultiMonitorSystem());
			} else {
