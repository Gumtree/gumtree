...
public class TCLRunnerPerspective_old implements IPerspectiveFactory {
...
//		factory.addShowViewShortcut(PLOT_VIEW_ID);
		...
		factory.addStandaloneView(SICS_TERMINAL_VIEW_ID, false, 
				IPageLayout.BOTTOM, 0.70f, WORKFLOW_VIEW_ID);
...
//				IPageLayout.BOTTOM, 0.493f, PLOT_VIEW_ID + ":2");
		...
		factory.addStandaloneView(CONTROL_VIEW_ID, true, 
				IPageLayout.TOP, 0.70f, factory.getEditorArea());
