...
public class EchidnaAnalysisLauncher extends AbstractLauncher {

	private static final String ID_PERSPECTIVE_DEFAULT = "org.gumtree.ui.isee.workbenchPerspective";
	
	public EchidnaAnalysisLauncher() {
	}
...
//						window.setActivePage(page);
		...
		mmManager.showPerspectiveOnOpenedWindow(EchidnaAnalysisPerspective.ANALYSIS_PERSPECTIVE_ID, 
