...
public class LowTemperaturePerspective implements IPerspectiveFactory {

	public static final String EXPERIMENT_PERSPECTIVE_ID = "au.gov.ansto.bragg.echidna.ui.LowTemperaturePerspective";
...
//				IPageLayout.BOTTOM, 0.70f, factory.getEditorArea());
		...
		factory.addStandaloneView(PROJECT_EXPLORER_VIEW_ID, true, 
				IPageLayout.LEFT, 0.50f, SICS_TERMINAL_VIEW_ID);
