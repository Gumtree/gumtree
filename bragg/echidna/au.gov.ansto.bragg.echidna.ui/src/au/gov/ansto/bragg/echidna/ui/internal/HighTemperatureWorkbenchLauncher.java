...
public class HighTemperatureWorkbenchLauncher extends AbstractLauncher {
	...
	private static final String ID_PERSPECTIVE_EXPERIMENT = "au.gov.ansto.bragg.echidna.ui.HighTemperaturePerspective";
...
//	private static final String ID_PERSPECTIVE_KAKADU = "au.gov.ansto.bragg.kakadu.ui.KakaduPerspective";
	...
	private static Logger logger = LoggerFactory.getLogger(HighTemperatureWorkbenchLauncher.class);
	
	public HighTemperatureWorkbenchLauncher() {
	}
