...
@Deprecated
public class HMViewContent implements IComponentViewContent {
...
//		String hmURL = SicsCore.getSicsManager().service().getCurrentInstrumentProfile().getProperty(EchidnaUIConstants.PROP_HISTOGRAM_URL);
