...
public class LowTemperatureWorkbenchLauncher extends AbstractLauncher {
	...
	private static final String ID_PERSPECTIVE_EXPERIMENT = "au.gov.ansto.bragg.echidna.ui.LowTemperaturePerspective";
...
//	private static final String ID_PERSPECTIVE_KAKADU = "au.gov.ansto.bragg.kakadu.ui.KakaduPerspective";
	...
	private static Logger logger = LoggerFactory.getLogger(LowTemperatureWorkbenchLauncher.class);
	
	public LowTemperatureWorkbenchLauncher() {
	}
