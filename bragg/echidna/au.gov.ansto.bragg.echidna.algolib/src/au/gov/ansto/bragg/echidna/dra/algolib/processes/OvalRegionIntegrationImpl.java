 ...
 *
 */
public class OvalRegionIntegrationImpl extends HRPDProcessor implements OvalRegionIntegration {
    ...
    public  double[][] ovalMaskRegion (double[][] data, int numSlices,	FPoint startpoint,
            FPoint endpoint, double xCenter,   double yCenter,  double dir, double[] thetaVect) {
        if (data == null) {
            return null;
        }
...
//                w = 1 + (double) Math.floor(dist) - dist;
                ...
                for (x=0; x<width; x++)
                {
                	...
                	{
                		ybound = MaskOvalAreaBounds(x, startpoint, endpoint, xCenter,  yCenter, dir) ;
                		double  yb1 = ybound[0];
                		double  yb2 = ybound[1];
    ...
    public static double[] MaskOvalAreaBounds(double xPosi, FPoint startpoint,   FPoint endpoint, 
    		double xCenter,  double yCenter, double dir) {
