 ...
 *
 */
public class HRPDGeometryCorrectImpl extends Processor implements HRPDGeometryCorrect {
...
//	protected static double detarc = 158.75;
	...
	public Signal process(Signal in) {
		...
		//HRPDGeometryCorrection metry = new HRPDGeometryCorrection();
...
//    public double[][] correctGeometry(HRPDDataSet data, double[] err,
