...
//			rotateText.setToolTipText("0 for stationary sample");
			...
			Realm.runWithDefault(SWTObservables.getRealm(Display.getDefault()), new Runnable() {
				public void run() {
					...
					bindingContext.bindValue(SWTObservables.observeText(sizeText, SWT.Modify),
							BeansObservables.observeValue(command, "size"),
							new UpdateValueStrategy(), new UpdateValueStrategy());
					bindingContext.bindValue(ViewersObservables.observeSingleSelection(sampposAB),
							BeansObservables.observeValue(command, "sampposAB"),
							new UpdateValueStrategy(), new UpdateValueStrategy());
