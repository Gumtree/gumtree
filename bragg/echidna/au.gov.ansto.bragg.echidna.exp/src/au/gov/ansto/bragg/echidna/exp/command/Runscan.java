...
import au.gov.ansto.bragg.echidna.exp.core.Command;
...
public class Runscan implements Command {
	...
	private EchidnaExperiment experiment;
	...
	/* (non-Javadoc)
	 * @see au.gov.ansto.bragg.echidna.exp.core.Command#getHelp()
	 */
	...
	/* (non-Javadoc)
	 * @see au.gov.ansto.bragg.echidna.exp.core.Command#getShortDescription()
	 */
	...
	/* (non-Javadoc)
	 * @see au.gov.ansto.bragg.echidna.exp.core.Command#run()
	 */
	public String run() {
		// TODO Auto-generated method stub
		...
		preset + " " + saveType;
		String resultFilename = "D:/dra/echidnadata/ECH0000700.nx.hdf";
	...
	/* (non-Javadoc)
	 * @see au.gov.ansto.bragg.echidna.exp.core.Command#setExperiment(au.gov.ansto.bragg.echidna.exp.core.EchidnaExperiment)
	 */
	...
	/* (non-Javadoc)
	 * @see au.gov.ansto.bragg.echidna.exp.core.Command#setParameter(java.lang.String[])
	 */
	...
	public EchidnaExperiment getExperiment(){
