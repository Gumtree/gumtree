...
*******************************************************************************/
package au.gov.ansto.bragg.echidna.exp.processor;
...
public class RunscanProcessor  {
	...
	public Boolean process() throws Exception {
		...
		EchidnaExperiment experiment = EchidnaExperiment.getInstance();
		String commandName = "hmscan";
		IWorkbenchWindow window = KakaduDOM.findKakaduWindow();
		if (window != null)
			EchidnaExperiment.showCommandLineView(window);
		else
			EchidnaExperiment.showCommandLineView();
