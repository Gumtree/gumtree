...
public enum EmuHMImageMode implements HMImageMode {
	...
	RAW_X_TAUX("Raw x-taux histogram", "&type=RAW_TOTAL_HISTOGRAM_XTAUX"),
	RAW_Y_TAUX("Raw y-taux histogram", "&type=RAW_TOTAL_HISTOGRAM_YTAUX"), 
	;
	private EmuHMImageMode(String label, String query) {
		this.label = label;
		this.query = query;
	}
