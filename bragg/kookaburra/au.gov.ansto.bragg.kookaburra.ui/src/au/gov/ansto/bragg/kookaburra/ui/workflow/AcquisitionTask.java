...
import au.gov.ansto.bragg.kookaburra.experiment.model.ControlledAcquisition;
import au.gov.ansto.bragg.kookaburra.experiment.model.Experiment;
import au.gov.ansto.bragg.kookaburra.experiment.model.SampleEnvironment;
import au.gov.ansto.bragg.kookaburra.experiment.model.SampleEnvironmentPreset;
import au.gov.ansto.bragg.kookaburra.experiment.report.ExperimentUserReport;
import au.gov.ansto.bragg.kookaburra.experiment.report.ExperimentUserReportUtils;
import au.gov.ansto.bragg.kookaburra.experiment.util.ExperimentModelUtils;
import au.gov.ansto.bragg.kookaburra.experiment.util.ExperimentScriptGenerator;
import au.gov.ansto.bragg.kookaburra.experiment.util.ExperimentStateManager;
import au.gov.ansto.bragg.kookaburra.experiment.util.IExperimentStateListener;
import au.gov.ansto.bragg.kookaburra.ui.KookaburraUIUtils;
import au.gov.ansto.bragg.kookaburra.ui.internal.Activator;
import au.gov.ansto.bragg.kookaburra.ui.internal.InternalImage;
import au.gov.ansto.bragg.kookaburra.ui.internal.SystemProperties;
...
public class AcquisitionTask extends AbstractExperimentTask {
	...
	public Object run(Object input) {
		 ...
		 *********************************************************************/
		boolean canRun = KookaburraUIUtils.checkTertiaryShutter(currentShell);
		if (!canRun) {
			// Stop all
			getWorkflow().stop();
			return null;
