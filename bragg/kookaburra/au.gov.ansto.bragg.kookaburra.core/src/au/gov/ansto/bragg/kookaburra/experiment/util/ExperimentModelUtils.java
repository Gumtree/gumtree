...
import au.gov.ansto.bragg.kookaburra.core.internal.KookaburraCoreProperties;
import au.gov.ansto.bragg.kookaburra.experiment.model.Acquisition;
import au.gov.ansto.bragg.kookaburra.experiment.model.AcquisitionEntry;
...
public final class ExperimentModelUtils {
	...
	private static Long getBeamMonitorRate() {
		try {
			...
			if (result <= 0) {
				return KookaburraCoreProperties.EXPECTED_MONITOR_RATE.getLong();
			}
			return result;
		} catch (Exception e) {
			// Use default
