...
import au.gov.ansto.bragg.wombat.exp.exception.WombatExperimentException;

/**
 * @author nxi
 * Created on 30/06/2008
 */
public class WombatExperiment extends InstrumentCommandSpace {

	static SicsDOM sics;
	static MonitorDOM monitor;
	static BeanShellCommandLineView beanShellView;
	static KakaduDOM kakadu;
	private static WombatExperiment experiment;
	protected String scanResultFilename;
	protected List<IGroup> resultEntryList;

	public final static String WOMBAT_COMMANDS_PACKAGE_NAME = "au.gov.ansto.bragg.wombat.exp.command";
//	public final static String QUOKKA_FUNCTIONS_PACKAGE_NAME = "au.gov.ansto.bragg.quokka.exp.core.scanfunction";

	public static WombatExperiment getInstance(){
		if (experiment == null){
			experiment = new WombatExperiment();
		}
		return experiment;
	}

	protected WombatExperiment(){
		super();
...
//		if (beanShellView == null) beanShellView = BeanShellCommandLineView.getInstance();
	...
	public static void showCommandLineView() throws WombatExperimentException {
