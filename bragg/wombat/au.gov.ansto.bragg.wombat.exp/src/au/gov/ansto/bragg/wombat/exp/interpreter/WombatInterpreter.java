...
public class WombatInterpreter extends InstrumentInterpreter{

	public WombatInterpreter(){
		super();
	}
	...
	private List<String> createMethodLines(String[] words) {
		...
		WombatCommand quokkaCommand = new WombatCommand(methodName, parameters);
