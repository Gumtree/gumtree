...
public class WombatAnalysisPerspective implements IPerspectiveFactory {

	public static final String ANALYSIS_ALGORITHM_NAME = "Reduction Algorithms 4.0";
	public static final String ANALYSIS_PERSPECTIVE_ID = "au.gov.ansto.bragg.wombat.ui.internal.WombatAnalysisPerspective";
...
//	public static final String COMMAND_LINE_VIEW_ID="org.gumtree.scripting.ui.commandLineView";
	public static final String EFFICIENCY_MAP_MANAGER_VIEW_ID = "au.gov.ansto.bragg.wombat.ui.views.EfficiencyMapManagerView";
...
//		bottom.addView(BEANSHELL_VIEW_ID);
		factory.addStandaloneView(ANALYSIS_PARAMETERS_VIEW_ID, false, 
				IPageLayout.BOTTOM, 0.62f, factory.getEditorArea());
...
//		IWorkbenchWindow workbenchWindow = PlatformUI.getWorkbench().getActiveWorkbenchWindow();
		...
		try {
			...
			kakadu.loadAlgorithm(cicada.loadAlgorithm(ANALYSIS_ALGORITHM_NAME), descriptor);
