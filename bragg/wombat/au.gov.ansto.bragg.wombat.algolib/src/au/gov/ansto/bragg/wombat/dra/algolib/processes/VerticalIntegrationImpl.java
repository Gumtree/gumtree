...
public class VerticalIntegrationImpl extends HIPDProcessor implements VerticalIntegration {

	@Override
	public Signal processNew(Signal in) {
		double[][] inData = in.dataAs(double[][].class);
		double[] extremals = verticalBoxBounds(inData, hid.beamX, hid.beamY, position);
		...
		double[][] y = findVerticalIntegration(inData, numSlices, extremals[0], extremals[1], hid.beamX,
				                  hid.beamY, position, null);
