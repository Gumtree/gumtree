...
public abstract class HIPDProcessor extends BufferedProcessor {

	protected HIPDDetector hid = new HIPDDetector();
	protected int nScan = hid.nScan ;
	protected int numSlices = hid.xPixels;
	protected  double detarc = hid.radialCurv;
	...
	public void setDetector(HIPDDetector det)
	{
		hid = det;
		forget();
	}
