...
//		insertParameter(parameter);
	...
	public String toScript() {
		...
		if (size > 0) {
			...
			script += "\tif {$idx < 1 || $idx > " + size + "} {error \"angle index doesn't exist.\"}\n";
...
//	
	...
	public String getPrintable() {
		String text = "# define angle table\n";
		text += "#angle,\t omega,\t ss1vg,\t ss2vg,\t ss3vg,\t pos\n";
		for (AbstractScanParameter parameter : getParameterList()) {
