...
public class PelicanStatusPerspective implements IPerspectiveFactory {

	public static final String EXPERIMENT_PERSPECTIVE_ID = "au.gov.ansto.bragg.pelican.ui.StatusPerspective";
...
//	public static final String DEFAULT_PERSPECTIVE_THEME = "au.gov.ansto.bragg.nbi.ui.EmptyPerspective";
	...
	public void createInitialLayout(IPageLayout factory) {
		...
		factory.addStandaloneView(ID_VIEW_ACTIVITY_MONITOR, false, 
				IPageLayout.BOTTOM, 0.60f, PELICAN_HM_VIEW_ID);
