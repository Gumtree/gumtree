...
*******************************************************************************/
package au.gov.ansto.bragg.nbi.dra.integration;
...
public class VerticalIntegration extends ConcreteProcessor {
	...
	public Boolean process() throws Exception {
		if (verticalIntegration_skip || verticalIntegration_inputPlot.getShortName().matches("emptyData")){
...
//		verticalIntegration_outputGroup = verticalIntegration_inputGroup.sumForDimension(0);
		verticalIntegration_outputPlot = 
			verticalIntegration_inputPlot.integrateDimension(
