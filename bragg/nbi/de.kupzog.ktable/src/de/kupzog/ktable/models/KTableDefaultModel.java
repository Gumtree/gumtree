...
public abstract class KTableDefaultModel implements KTableModel {
     ...
     */
    public IKTableTooltip getTooltip(int col, int row) {
        return doGetTooltip(col, row);
    }
     ...
     */
    public IKTableTooltip doGetTooltip(int col, int row) {
        return null;
    }
    ...
    /**
     * Вызывается для получения action фиксированной активной ячейки 
     */
    public abstract KTableCellAction doGetCellAction(int col, int row);
    /**
     * Вызывается метод <code>getCellAction(int, int)</code>
     * для получения action фиксированной активной ячейки 
     * @see de.kupzog.ktable.models.KTableModel#getCellAction(int, int)
     */
    public final KTableCellAction getCellAction(int col, int row) {
    	return doGetCellAction(col, row);
    }
     ...
     * @see de.kupzog.ktable.models.KTableModel#getFixedHeaderRowCount()
     * @see de.kupzog.ktable.models.KTableModel#getFixedSelectableRowCount()
     */
     ...
     * @see de.kupzog.ktable.models.KTableModel#getFixedHeaderColumnCount()
     * @see de.kupzog.ktable.models.KTableModel#getFixedSelectableColumnCount()
     */
