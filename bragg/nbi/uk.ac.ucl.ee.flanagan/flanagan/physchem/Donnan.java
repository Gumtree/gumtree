...
public class Donnan{
    ...
    private Vector<Object> vec = new Vector<Object>();      //  vector holding:
    ...
    public void setIon(String ion, double concnA, double concnB, double assocK, double radius, int charge){
        this.vec.addElement(ion);
        this.vec.addElement(new Double(concnA));
        this.vec.addElement(new Double(concnB));
        if(concnA>0.0D || concnB>0.0)this.nonZeroConcns++;
        this.vec.addElement(new Double(assocK));
        if(assocK!=0.0D)this.nonZeroAssocK++;
        this.vec.addElement(new Double(radius));
        this.vec.addElement(new Integer(charge));
        this.vec.addElement(new Double(-1.0D));
        this.numOfIons++;
    }
    ...
    public void setIon(double partCoeff, String ion, double concnA, double concnB, double assocK, double radius, int charge){
        ...
        this.vec.addElement(new Double(radius));
        this.vec.addElement(new Integer(charge));
        this.vec.addElement(new Double(partCoeff));
        this.numOfIons++;
    }
    ...
    public void setIon(String ion, double concnA, double concnB, double radius, int charge){
        ...
        this.vec.addElement(new Double(concnB));
        if(concnA>0.0D || concnB>0.0)this.nonZeroConcns++;
        this.vec.addElement(new Double(0.0D));
        this.vec.addElement(new Double(radius));
        this.vec.addElement(new Integer(charge));
        this.vec.addElement(new Double(-1.0D));
        this.numOfIons++;
    ...
    public void setIon(String ion, double concnA, double concnB, double assocK){
        ...
        this.vec.addElement(new Double(rad));
        int charg = 0;
        charg = ir.charge(ion);
        if(charg==0){
        ...
        this.vec.addElement(new Integer(charg));
        this.vec.addElement(new Double(-1.0D));
        this.numOfIons++;
    }
   ...
   // Method to add an ionic species to the  Donnan Equilibrium
    ...
    public double[] getConcnA(){
        double[] concn = (double[])this.concnA.clone();
    ...
    public double[] getConcnB(){
        double[] concn = (double[])this.concnB.clone();
        for(int i=0; i<this.numOfIons; i++)concn[i] *= 1e-3;
        return concn;
    }
    ...
    public double[] getComplex(){
        double[] concn = (double[])this.complex.clone();
        for(int i=0; i<this.numOfIons; i++)concn[i] *= 1e-3;
        return concn;
    }
    ...
    public double[] getExcessConcnA(){
        ...
        double[] concn = (double[])this.excessConcnA.clone();
        for(int i=0; i<this.numOfIons; i++)concn[i] *= 1e-3;
        return concn;
    }
    ...
    public double[] getExcessConcnB(){
        ...
        double[] concn = (double[])this.excessConcnB.clone();
        for(int i=0; i<this.numOfIons; i++)concn[i] *= 1e-3;
        return concn;
    }
    ...
    public double[] getExcessComplex(){
        ...
        double[] concn = (double[])this.excessComplex.clone();
        for(int i=0; i<this.numOfIons; i++)concn[i] *= 1e-3;
        return concn;
    }
    ...
    public double calcPotential(){
        ...
        if(this.nonZeroConcns<this.numOfIons){
            assocConstshold = (double[])this.assocConsts.clone();
            radiihold = (double[])this.radii.clone();
            chargeshold = (double[])this.charges.clone();
            deltaMu0hold = (double[])this.deltaMu0.clone();
            partCoeffhold = (double[])this.partCoeff.clone();
            boolean test = true;
            int jj = 0;
            while(test){
                if(indexC[jj]==0){
    ...
    // Unpacks the ion storage vector and fills the appropriate arrays
    ...
    private void unpack(){
        ...
        for(int i=0; i<numOfIons; i++){
            // ion name
            this.ionNames[i]= (String)this.vec.elementAt(0+i*7);
            // concentration in compartment A
            hold            = (Double)this.vec.elementAt(1+i*7);
            this.concnA[i]  = hold.doubleValue()*1e3;
            hold            = (Double)this.vec.elementAt(2+i*7);
            ...
            hold            = (Double)this.vec.elementAt(3+i*7);
            ...
            // ion radius
            hold            = (Double)this.vec.elementAt(4+i*7);
            this.radii[i]   = hold.doubleValue();
            // ion charge
            holi            = (Integer)this.vec.elementAt(5+i*7);
            ...
            hold        = (Double)this.vec.elementAt(6+i*7);
