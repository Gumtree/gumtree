...
public class Maximisation{
    ...
    private double[]paramValue = null;      // function parameter values (returned at function maximum)
	private String[] paraName = null;   	// names of parameters, eg, c[0], c[1], c[2] . . .
	private double functValue = 0.0D;       // current value of the function to be maximised
    private double lastFunctValNoCnstrnt=0.0D;// Last function value with no constraint penalty
	private double maximum = 0.0D;          // value of the function to be maximised at the maximum
    ...
    private boolean convStatus = false;     // Status of maximisation on exiting maximisation method
    ...
    private int maxTest = 0;    		    // Nelder and Mead maximum test
    ...
    // Nelder and Mead Simplex maximisation
    public void nelderMead(MaximisationFunction g, double[] start, double[] step, double fTol, int nMax){
	...
	private double functionValue(MaximisationFunction g, double[] x){
	    double funcVal = -3.0D;
