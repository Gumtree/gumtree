 ...
 *
 */
public class RealtimeDataComposite extends Composite {
	 ...
	 * @param style
	 */
	public RealtimeDataComposite(Composite parent, int style) {
		super(parent, style);
		isDisposed = false;
	    			...
	    			if (selection != null && selection instanceof IStructuredSelection) {
	    				...
	    				for(Object struct : structures.toList()) {
	    					if(struct instanceof DynamicControllerNode) {
	    						ISicsController controller = ((DynamicControllerNode) struct).getController();
	    						try {
		    						...
		    						if (deviceId != null) {
		    							...
		    							if (resource != null && resource instanceof ControlRealtimeResource) {
