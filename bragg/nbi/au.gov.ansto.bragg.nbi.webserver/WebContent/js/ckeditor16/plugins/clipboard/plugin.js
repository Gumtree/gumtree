...
//					if ( !data && dataObj.method == 'paste' && isFileData( dataTransfer ) ) {
					console.log("clipboard check content");
					console.log(dataTransfer.getFilesCount());
					if ( !data && dataObj.method == 'paste' && dataTransfer 
							&& dataTransfer.getFilesCount() == 1 && latestId != dataTransfer.id ) {
						var file = dataTransfer.getFile( 0 );

						if ( CKEDITOR.tools.indexOf( supportedImageTypes, file.type ) != -1 ) {
							console.log("using clipboard plugin 16");
			...
			editor.on( 'paste', function( evt ) {
				console.log("clipboard check datatransfer");
