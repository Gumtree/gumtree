...
function ajaxindicatorstart(text)
{
	...
	jQuery('body').append('<div id="resultLoading" style="display:none"><div><img src="images/ajax-loader.gif" alt="Please Wait" style="border:0px;"><div>'+text+'</div></div><div class="bg"></div></div>');
	}
