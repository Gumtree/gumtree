...
public class LinkedJSONTokener {
    /** The input JSON. */
     ...
     *     called.
     */
    public LinkedJSONTokener(String in) {
        this.in = in;
    }
    /**
     ...
     */
    private LinkedJSONObject readObject() throws JSONException {
    	LinkedJSONObject result = new LinkedJSONObject();
