...
*******************************************************************************/
package au.gov.ansto.bragg.kowari.exp.interpreter;

import java.util.ArrayList;
import java.util.Iterator;
import java.util.List;

public class KowariCommand {
	private String methodName = null;
	private List<String> parameters = null;
	static final String IMPORT_EXPERIMENT = 
...
//	static final String IMPORT_FACTORY = "import au.gov.ansto.bragg.quokka.exp.core.ExperimentFactory";
	...
	public KowariCommand(String methodName, List<String> parameters){
...
//		if (methodName.matches("setFunction")){
		command = "experiment = WombatExperiment.getInstance()";
		commandLines.add(command);
