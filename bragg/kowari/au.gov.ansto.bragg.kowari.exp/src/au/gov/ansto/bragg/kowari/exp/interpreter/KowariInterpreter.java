...
public class KowariInterpreter extends InstrumentInterpreter{

	public KowariInterpreter(){
		super();
	}
	...
	private List<String> createMethodLines(String[] words) {
		...
		KowariCommand quokkaCommand = new KowariCommand(methodName, parameters);
