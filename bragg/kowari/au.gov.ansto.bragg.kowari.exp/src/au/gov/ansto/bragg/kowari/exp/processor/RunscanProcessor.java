...
public class RunscanProcessor  {
	...
	private Boolean runscan_trigger = true;
	...
	public Boolean process() throws Exception {
		if (!runscan_trigger)
			throw new TransferFailedException("the previous step was not finished correctly");
...
//		if (window != null)
//			KowariExperiment.showCommandLineView(window);
//		else
		KowariExperiment.showCommandLineView();
...
//		Thread.sleep(10000);
		...
		if (entryList != null && entryList.size() > 0){
			...
			throw new KowariExperimentException("The data is not available.");
	}
	...
	/**
	 * @param runscan_trigger the runscan_trigger to set
	 */
	public void setRunscan_trigger(Boolean runscan_trigger) {
		this.runscan_trigger = runscan_trigger;
	}
