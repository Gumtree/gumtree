...
*******************************************************************************/
package au.gov.ansto.bragg.kowari.exp.core;
...
import au.gov.ansto.bragg.kowari.exp.exception.KowariExperimentException;
import au.gov.ansto.bragg.kowari.exp.python.PythonExecutor;
...
//		ScriptEngine engine = ScriptingCore.getScriptingManager().createEngine();
		executor = new ScriptExecutor();
//		runPythonScript("from gumpy.commons import sics", true);
	...
	public void runPythonScript(String script, boolean silenceMode){
		PythonExecutor.runScript(executor, script, silenceMode);
	}
	
	public void runPythonBlock(ScriptBlock block, boolean silenceMode){
		PythonExecutor.runScript(executor, block, silenceMode);
	}
	@Override
	public String runCommand(String commandName, String... params) {
		...
		try {
			command = (Command) Class.forName(WOMBAT_COMMANDS_PACKAGE_NAME + "."
...
//		return beanShellView;
	...
	public static void showCommandLineView() throws KowariExperimentException {
