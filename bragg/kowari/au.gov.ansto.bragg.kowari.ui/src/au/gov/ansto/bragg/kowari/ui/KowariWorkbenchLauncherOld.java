...
public class KowariWorkbenchLauncherOld extends AbstractLauncher {
	...
	private static final String ID_PERSPECTIVE_EXPERIMENT = "au.gov.ansto.bragg.kowari.ui.internal.TCLRunnerPerspectiveOld";
	...
	private static Logger logger = LoggerFactory.getLogger(KowariWorkbenchLauncherOld.class);
	
	public KowariWorkbenchLauncherOld() {
	}
...
//			mmManager.showPerspectiveOnOpenedWindow(ID_PERSPECTIVE_DEFAULT, 2, 2, mmManager.isMultiMonitorSystem());
