...
public class AnalysisApplicationLauncher extends AbstractLauncher {

	private static final String ID_PERSPECTIVE_DEFAULT = "org.gumtree.ui.isee.workbenchPerspective";
	
	public AnalysisApplicationLauncher() {
	}
...
//		mmManager.openWorkbenchWindow(ID_PERSPECTIVE_DEFAULT, 2, false);
		mmManager.showPerspectiveOnOpenedWindow(QuokkaAnalysisPerspective.PERSPECTIVE_ID, 0, 
				2, true);
	}
