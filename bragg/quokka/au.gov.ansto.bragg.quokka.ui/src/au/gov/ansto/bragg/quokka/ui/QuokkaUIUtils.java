...
public class QuokkaUIUtils {

	private static final Logger logger = LoggerFactory.getLogger(QuokkaUIUtils.class);
	
	/** [GT-99] Property for checking tertiary shutter */
	private static final String PROP_CHECK_TERTIARY_SHUTTER = "quokka.scan.checkTertiaryShutter";
