...
public class QuokkaInterpreter extends InstrumentInterpreter{

	public QuokkaInterpreter(){
		super();
	}
	...
	private List<String> createMethodLines(String[] words) {
		...
		QuokkaCommand quokkaCommand = new QuokkaCommand(methodName, parameters);
