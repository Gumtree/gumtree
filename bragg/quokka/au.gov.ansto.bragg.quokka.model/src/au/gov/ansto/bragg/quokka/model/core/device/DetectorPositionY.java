 ...
 */
public class DetectorPositionY extends VirtualDevice {


	private static DetectorPositionY instance;
	/**
	 * 
	 */
	protected DetectorPositionY() {
		// TODO Auto-generated constructor stub
		super();
		setId("detposymm");
		setName("DetPosYmm");
		setUnit("mm");
		setDescription("The detector position in Y");
		setRadonly(true);
		deviceType = DeviceType.setable;
	}

	public static DetectorPositionY getInstance(){
		if (instance == null){
			instance = new DetectorPositionY();
		}
		return instance;
	}
