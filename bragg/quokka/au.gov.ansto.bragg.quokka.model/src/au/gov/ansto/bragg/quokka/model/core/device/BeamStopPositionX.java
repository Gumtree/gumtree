 ...
 */
public class BeamStopPositionX extends VirtualDevice {


	private static BeamStopPositionX instance;

	/**
	 * 
	 */
	public BeamStopPositionX() {
		// TODO Auto-generated constructor stub
		super();
		setId("bsposxmm");
		setName("BSPosXmm");
		setUnit("mm");
		setDescription("The beam stop position in X direction");
		deviceType = DeviceType.setable;
	}

	public static BeamStopPositionX getInstance(){
		if (instance == null){
			instance = new BeamStopPositionX();
		}
		return instance;
	}
