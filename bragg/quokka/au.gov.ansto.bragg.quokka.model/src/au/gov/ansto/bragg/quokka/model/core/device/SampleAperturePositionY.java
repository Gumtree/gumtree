 ...
 */
public class SampleAperturePositionY extends VirtualDevice {

	private static SampleAperturePositionY instance;

	/**
	 * 
	 */
	public SampleAperturePositionY() {
		// TODO Auto-generated constructor stub
		super();
		setId("sapposymm");
		setName("SApPosYmm");
		setUnit("mm");
		setDescription("Sample Aperture Position in Y");
		deviceType = DeviceType.setable;
	}

	public static SampleAperturePositionY getInstance(){
		if (instance == null){
			instance = new SampleAperturePositionY();
		}
		return instance;
	}
