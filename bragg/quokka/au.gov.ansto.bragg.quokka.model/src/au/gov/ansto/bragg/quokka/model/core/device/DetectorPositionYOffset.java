 ...
 */
public class DetectorPositionYOffset extends VirtualDevice {

	private static DetectorPositionYOffset instance;

	/**
	 * 
	 */
	public DetectorPositionYOffset() {
		// TODO Auto-generated constructor stub
		super();
		setId("detposoffsetmm");
		setName("DetPosYOffsetmm");
		setUnit("mm");
		setDescription("Detector Position Offset at Y");
		deviceType = DeviceType.setable;
	}

	public static DetectorPositionYOffset getInstance(){
		if (instance == null){
			instance = new DetectorPositionYOffset();
		}
		return instance;
	}
