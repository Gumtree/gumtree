 ...
 */
public class SampleApertureX extends VirtualDevice {

	private static SampleApertureX instance;

	/**
	 * 
	 */
	public SampleApertureX() {
		// TODO Auto-generated constructor stub
		super();
		setId("sapxmm");
		setName("SApXmm");
		setUnit("mm");
		setDescription("Sample Aperture Size in X");
		deviceType = DeviceType.setable;
	}

	public static SampleApertureX getInstance(){
		if (instance == null){
			instance = new SampleApertureX();
		}
		return instance;
	}
