 ...
 */
public class BeamStopShape extends VirtualDevice {

	protected static BeamStopShape instance;
	/**
	 * 
	 */
	public BeamStopShape() {
		// TODO Auto-generated constructor stub
		super();
		setId("bsshape");
		setName("Beam Stop Shape");
		setUnit("");
		setDescription("Beam Stop Shape");
//		setSicsDevicePath(QuokkaConstants.SampleSelect_PATH);
		deviceType = DeviceType.setable;
	}

	public static BeamStopShape getInstance(){
		if (instance == null){
			instance = new BeamStopShape();
		}
		return instance;
	}
	/* (non-Javadoc)
	 ...
	 */
	@Override
	protected void changeModel(Object shape)
			throws DriveDeviceFailedException {
		// TODO Auto-generated method stub
		getQuokkaModel().setBeamStopShape(shape.toString());
	}
