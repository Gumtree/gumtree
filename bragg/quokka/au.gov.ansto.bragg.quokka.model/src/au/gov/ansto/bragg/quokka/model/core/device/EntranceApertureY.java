 ...
 */
public class EntranceApertureY extends VirtualDevice {

	private static EntranceApertureY instance;

	/**
	 * 
	 */
	public EntranceApertureY() {
		// TODO Auto-generated constructor stub
		super();
		setId("eapymm");
		setName("EApYmm");
		setUnit("mm");
		setDescription("Entrance Aperture Size in Y");
		deviceType = DeviceType.setable;
	}

	public static EntranceApertureY getInstance(){
		if (instance == null){
			instance = new EntranceApertureY();
		}
		return instance;
	}
