 ...
 */
public class PerspexThickness extends VirtualDevice {

	private static PerspexThickness instance;

	/**
	 * 
	 */
	public PerspexThickness() {
		// TODO Auto-generated constructor stub
		super();
		setId("plexmm");
		setName("Plexmm");
		setUnit("");
		setDescription("Perspex Thicknesses");
		deviceType = DeviceType.setable;
	}

	public static PerspexThickness getInstance(){
		if (instance == null){
			instance = new PerspexThickness();
		}
		return instance;
	}
