 ...
 */
public class SamplePositionX extends VirtualDevice {

	private static SamplePositionX instance;

	/**
	 * 
	 */
	public SamplePositionX() {
		// TODO Auto-generated constructor stub
		super();
		setId("sampleposxmm");
		setName("SamplePosXmm");
		setUnit("mm");
		setDescription("Sample Position in X");
		deviceType = DeviceType.setable;
	}

	public static SamplePositionX getInstance(){
		if (instance == null){
			instance = new SamplePositionX();
		}
		return instance;
	}
