 ...
 */
public class VelocitySeletorRpm extends VirtualDevice {

	private static VelocitySeletorRpm instance;

	/**
	 * 
	 */
	public VelocitySeletorRpm() {
		// TODO Auto-generated constructor stub
		super();
		setId("vsrpm");
		setName("VSrpm");
		setUnit("rpm");
		setDescription("Velocity Seletor Speed in RPM");
		deviceType = DeviceType.setable;
	}

	public static VelocitySeletorRpm getInstance(){
		if (instance == null){
			instance = new VelocitySeletorRpm();
		}
		return instance;
	}
