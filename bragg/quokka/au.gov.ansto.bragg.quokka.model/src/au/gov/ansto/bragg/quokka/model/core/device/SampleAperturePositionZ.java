 ...
 */
public class SampleAperturePositionZ extends VirtualDevice {


	private static SampleAperturePositionZ instance;

	/**
	 * 
	 */
	public SampleAperturePositionZ() {
		// TODO Auto-generated constructor stub
		super();
		setId("sapposzmm");
		setName("SApPosZmm");
		setUnit("mm");
		setDescription("Sample Aperture Position in Z");
		deviceType = DeviceType.setable;
	}

	public static SampleAperturePositionZ getInstance(){
		if (instance == null){
			instance = new SampleAperturePositionZ();
		}
		return instance;
	}
