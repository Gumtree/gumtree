 ...
 *
 */
public class DetectorX extends VirtualDevice {

//	private String description = "The device that moves detector in the X direction.\n" +
//	"Default position is 0mm.";

	protected static DetectorX instance;
	/**
	 * 
	 */
	protected DetectorX() {
//		TODO Auto-generated constructor stub
		...
		setId("detector_x");
		setName("Detector X");
		setDescription("The device that moves detector in the X direction.\n" +
			"Default position is 0mm.");
		deviceType = DeviceType.moveable;
	}

	public static DetectorX getInstance(){
		if (instance == null){
			instance = new DetectorX();
		}
		return instance;
	}
//	/* (non-Javadoc)
...
//	}
	...
	protected void changeModel(Object positionObject) throws DriveDeviceFailedException {
		...
		getQuokkaModel().moveDetectorCenterX(position);
	}	
}