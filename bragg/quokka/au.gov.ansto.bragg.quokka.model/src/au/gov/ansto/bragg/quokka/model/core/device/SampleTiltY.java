 ...
 */
public class SampleTiltY extends VirtualDevice {

	private static SampleTiltY instance;
	...
	public SampleTiltY() {
		...
		super();
		setId("sampletiltydeg");
		setName("SampleTiltYdeg");
		setUnit("mm");
		setDescription("The sample tilt angle in Y");
		deviceType = DeviceType.setable;
	}

	public static SampleTiltY getInstance(){
		if (instance == null){
			instance = new SampleTiltY();
		}
		return instance;
	}
