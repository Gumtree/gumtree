...
public class Blank_Patch extends ConcreteProcessor {
	
	private static final String processClass = "Blank_Patch"; 
	private static final String processClassVersion = "1.0"; 
	private static final long processClassID = 2009022301; 
	...
	public void setInPlot(IGroup inPlot) {
