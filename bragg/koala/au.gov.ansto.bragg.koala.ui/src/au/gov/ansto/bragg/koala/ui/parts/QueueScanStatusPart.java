...
public class QueueScanStatusPart {

	private static final Logger logger = LoggerFactory.getLogger(QueueScanStatusPart.class);
	...
	public QueueScanStatusPart(final Composite parent, final MainPart main) {
		mainPart = main;
...
//							ControlHelper.asyncExec("collect stop");
		...
		GridDataFactory.fillDefaults().grab(true, false).align(SWT.FILL, SWT.CENTER)
			.hint(320, 80).applyTo(abortButton);
