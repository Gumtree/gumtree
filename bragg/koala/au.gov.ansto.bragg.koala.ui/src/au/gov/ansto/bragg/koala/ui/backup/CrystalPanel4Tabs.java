...
import au.gov.ansto.bragg.koala.ui.parts.CrystalPanel;
 ...
 *
 */
public class CrystalPanel4Tabs extends AbstractControlPanel {
	 ...
	 * @param style
	 */
	public CrystalPanel4Tabs(Composite parent, int style, MainPart part) {
		super(parent, style);
		mainPart = part;
