...
public class ChemistryWorkflowViewer extends Composite {

	private ScriptExecutor Jython_Executor;
	private static final String WORKFLOW_SCRIPT_NAME = "gumtree.scripting.chemistryScript";
...
//	private ScriptExecutor scriptValidator;
	...
	public ChemistryWorkflowViewer(Composite parent, int style) {
		super(parent, style);
		GridLayoutFactory.fillDefaults().applyTo(this);
		ScriptPageRegister register = new ScriptPageRegister();
		
		level1Form = new SashForm(this, SWT.VERTICAL);
...
//		SashForm level2Left = new SashForm(level1Form, SWT.VERTICAL);
		SashForm level2Right = new SashForm(level1Form, SWT.HORIZONTAL);
...
//		SashForm level4Left = new SashForm (level3Form, SWT.VERTICAL);
		SashForm level4Top = new SashForm(level3Form, SWT.VERTICAL);
...
//		GridDataFactory.fillDefaults().grab(true, true).applyTo(controlViewer);
		...
		cameraViewer = new VlcjViewer(parent, SWT.HORIZONTAL);
