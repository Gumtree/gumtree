...
//		            Thread.sleep(50); 
    ...
    {
    	KoalaServer server = new KoalaServer(LOCAL_SERVER_ADDRESS, LOCAL_PUBLISHER_ADDRESS);
    	server.run();
    	
//    	KoalaServer validator = new KoalaServer(VALIDATOR_SERVER_ADDRESS, VALIDATOR_PUBLISHER_ADDRESS);
//    	validator.run();
