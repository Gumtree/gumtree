...
public final class PyScriptEngineScope extends PyObject {
    ...
    public PyObject invoke(String name) {
    	// [GUMTREE-718] There is a side effect of recompiling this class for
    	// patching: exposed method will not be recognised by Jython.
    	// Usually for a method to be exposed, an additional ANT task should be
    	// run (see: http://wiki.python.org/jython/PythonTypesInJava)
    	// In this case, dir() will not work because scope_keys() is not exposed.
    	if ("keys".equals(name)) {
    		return scope_keys();
    	} else {
