...
import au.gov.ansto.bragg.cicada.core.TunerConfiguration;
...
public class NcTunerConfiguration extends NcGroup implements TunerConfiguration {
	...
	public NcTunerConfiguration(IGroup parent, String shortName, String recipeID, String algorithmName) {
		...
		addStringAttribute("dataStructureType", "configuration");
		// TODO Auto-generated constructor stub
	}

	public NcTunerConfiguration(IGroup configurationGroup) {
		// TODO Auto-generated constructor stub
		super ((NcGroup) configurationGroup, (NcDataset) configurationGroup.getDataset());
	}
	...
	public Object getTunerValue(String tunerName) {
		...
		IGroup valueGroup = getValueGroup(stringValue);
		if (valueGroup != null)
			return valueGroup;
		return stringValue;
	}
	...
	public String getDefaultSinkName() throws IOException {
		// TODO Auto-generated method stub
		IDataItem defaultSinkData = findDataItem("defaultSinkName");
		if (defaultSinkData == null)
			return null;
		return defaultSinkData.getData().toString();
	}
	...
	throws InvalidArrayTypeException {
		...
		if (defaultSinkData == null)
			return;
		defaultSinkData.setCachedData(Factory.createArray(sinkName.toCharArray()), false);
	}
