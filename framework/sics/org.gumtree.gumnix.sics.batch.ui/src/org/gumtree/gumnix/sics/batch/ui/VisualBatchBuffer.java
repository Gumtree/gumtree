...
import org.gumtree.gumnix.sics.batch.ui.buffer.BatchBuffer;
...
public class VisualBatchBuffer extends BatchBuffer {
	
	public static final String PROP_BUFFER_NAME = "bufferName";
	
	public VisualBatchBuffer(String name, IWorkflow workflow) {
		super(name);
