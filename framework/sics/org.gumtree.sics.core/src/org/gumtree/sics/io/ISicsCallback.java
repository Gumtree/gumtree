...
public interface ISicsCallback {
	...
	/**
	 * This method is called from client receives raw data output (usually
	 * non-JSON data)
	 * 
	 * @param data
	 */
	...
	/**
	 * If receiveError() is called, class which implements this interface should
	 * call this method to indicate error.
	 * 
	 * @param error
	 *            true for error; false otherwise
	 */
