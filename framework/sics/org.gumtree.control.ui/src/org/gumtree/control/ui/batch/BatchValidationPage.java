...
public class BatchValidationPage extends ExtendedFormComposite {
	...
	protected void render() {
		...
		// Queue
		context.queueViewer = new BatchQueueViewer(this, SWT.SINGLE | SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER);
		...
		context.queueViewer.getViewer().addSelectionChangedListener(new ISelectionChangedListener() {
			public void selectionChanged(SelectionChangedEvent event) {
				IBatchScript buffer = (IBatchScript) ((IStructuredSelection) event.getSelection()).getFirstElement();
				if (buffer != null) {
		...
		validateButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				IBatchScript buffer = (IBatchScript) ((IStructuredSelection) context.queueViewer.getViewer()
...
//			}
	...
	private void runValidation(IBatchScript buffer) {
