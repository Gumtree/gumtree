...
public class BatchTaskLibrary extends AbstractWorkflowViewerComponent {

	private static final Logger logger = LoggerFactory.getLogger(BatchTaskLibrary.class);
	private TreeNode commandTreeNode;
	private TreeNode scientistFolder;
	private TreeNode userFolder;
	
	public BatchTaskLibrary(Composite parent, int style) {
		super(parent, style);
	}
