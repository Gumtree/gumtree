 ...
 *******************************************************************************/
package org.gumtree.vis.widgets;
...
//import au.gov.ansto.bragg.kakadu.core.data.region.ParameterRegionManager;
//import au.gov.ansto.bragg.kakadu.core.data.region.UIRegion;
 ...
 */
public class OldPlot extends Composite {

	public OldPlot(Composite parent, int style) {
		super(parent, style);
...
//	private final Map<String, UIRegion> maskMap = new HashMap<String, UIRegion>();
...
////		logarithmToolItem.setToolTipText("Logarithm");
...
//		currentKurandaWidget.setMaskingEnabled(isMaskingEnabled && parameterRegionManager != null);
//	}
//	/**
...
//	}
//	
//	private void loadMaskList(List<UIRegion> regions) {
//		if (currentKurandaWidget != null) {
//			if (regions != null) {
...
//	 */
//	private void addMask(UIRegion region) {
//		if (currentKurandaWidget == null) {
//			return;
//		}
//
...
//
//				maskMap.put(mask.getName(), region);
//
//				currentKurandaWidget.repaint();
//			} catch (Exception e) {
//				handleException(e);
...
//	}
//	
//	private void updateMask(UIRegion region) {
//		isInnerPlotRegionProcessing = true;
//
//		for (Iterator<String> iterator = maskMap.keySet().iterator(); iterator.hasNext();) {
//			String regionId = iterator.next();
...
////			currentKurandaWidget.addRegionListener(plotRegionListener);
...
//	}
//
////	private final class PlotRegionListener implements IRegionListener {
////		public void regionAdded(final Region region) {
...
////						
////						UIRegion uiRegion = new UIRegion(region.isInclusiveMask(), region.getXMin(),
////								region.getYMin(), region.getXMax(), region.getYMax());
////						
////						uiRegion.setName("Mask " + uiRegion.getId());
////						
////						parameterRegionManager.addRegion(uiRegion);
////						
////						region.setRegionName(uiRegion.getName());
////						
////						maskMap.put(region.getRegionID(), uiRegion);
////						
////						
...
////		}
////
////		public void regionRemoved(final Region region) {
...
////					public void run() {
////						isInnerUIRegionProcessing = true;
////						final UIRegion uiRegion = maskMap.remove(region.getRegionID());
////						if (uiRegion != null) {
...
////		}
////
////		public void regionUpdated(final Region region) {
////			System.out.println("PlotRegionListener.regionUpdated() " + region);
////			
////			if (!isInnerPlotRegionProcessing) {
////				DisplayManager.getDefault().asyncExec(new Runnable() {
////					public void run() {
////						isInnerUIRegionProcessing = true;
////						final UIRegion uiRegion = maskMap.get(region.getRegionID());
////						if (uiRegion != null) {
////							parameterRegionManager.updateRegion(uiRegion.getId(), 
////									uiRegion.getName(), uiRegion.isInclusive(), 
////									region.getXMin(), region.getYMin(), 
////									region.getXMax(), region.getYMax());
////						}
////						isInnerUIRegionProcessing = false;
////					}
////				});
...
//			removeAllMasks();
//			currentKurandaWidget.setMaskingEnabled(isMaskingEnabled && parameterRegionManager != null);
//			if (isMaskingEnabled && parameterRegionManager != null) {
//				loadMaskList(parameterRegionManager.getRegions());
//			}
//		}
//	}
//	
...
//					getActiveShell(), formatName, "'" + formatName + "' data file");
//			if (saveFilename == null)
//				return;
//			final URI fileURI = (new File(saveFilename)).toURI();
//			
...
//					if (multiPlotDataManager.getPlotDataItems().size() > 0)
//						plotDataItem = multiPlotDataManager.getPlotDataItems().get(0);
//					else 
//						return;
//				}
//				if (plotDataItem != null) {
//					dataObject = plotDataItem.getData();
//				}
//				System.out.println("Export data for PlotDataItem '" + plotDataItem +
//						"' to file '" + fileURI + "'...");
////				break;
////			}
//			
...
//			
//			try {
//				exporter.signalExport(dataObject, fileURI);
//			} catch (ExportException e1) {
//				handleException(e1);
//			} 
//		}
