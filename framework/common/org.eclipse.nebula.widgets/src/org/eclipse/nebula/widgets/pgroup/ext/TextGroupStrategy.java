...
/**
 * TextGroupStrategy is modified from SimpleGroupStrategy with line removed.
 * 
 * @since 1.0
 * @author chris
 */
public class TextGroupStrategy extends AbstractGroupStrategy
{
    ...
    {
    	// [ANSTO][Tony][2011-06-15] Disabled because we cannot access this method
...
//        }
        ...
        if (x2 > x)
        {
            ...
            // [ANSTO][Tony][2011-06-15] disable line drawing
