...
public class VaadinOSGiTouchKitServlet extends TouchKitApplicationServlet {

	private final ComponentFactory factory;

	private Set<VaadinSession> sessions = new HashSet<VaadinSession>();

	public VaadinOSGiTouchKitServlet(ComponentFactory factory) {
	...
	protected Application getNewApplication(HttpServletRequest request)
		...
		info.session.setAttribute(VaadinOSGiTouchKitServlet.class.getName(),
	...
	class VaadinSession {
		...
		public void dispose() {
			...
			session.removeAttribute(VaadinOSGiTouchKitServlet.class.getName());
