...
public abstract class AbstractRenderer implements Cloneable, Serializable {
    ...
    public void removeSeries(int series) {
    	paintList.remove(series);
    	fillPaintList.remove(series);
    	outlinePaintList.remove(series);
    	outlineStrokeList.remove(series);
    	strokeList.remove(series);
    	shapeList.remove(series);
    	seriesVisibleList.remove(series);
    	seriesVisibleInLegendList.remove(series);
    	itemLabelFontList.remove(series);
    	itemLabelPaintList.remove(series);
    	itemLabelsVisibleList.remove(series);
    }
}
