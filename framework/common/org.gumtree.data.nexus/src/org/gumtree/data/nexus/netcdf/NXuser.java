...
/**
 * Netcdf implementation of NeXus NXuser.
 * @author nxi
 * 
 */
public class NXuser extends NXGroup implements INXuser {
	 ...
	 */
	public NXuser(final NcDataset dataset, final NcGroup parent,
	 ...
	 *            String value
	 */
	public NXuser(final NcGroup parent, final String shortName) {
	 ...
	 * @param shortName
	 */
	// public NXuser(NcDataset dataset, Group parent, String shortName) {
	 ...
	 *            NcDataset object
	 */
	public NXuser(final Group from, final NcDataset dataset) {
		super(from, dataset);
	}
	 ...
	 *            GDM IGroup object
	 */
	public NXuser(final IGroup from) {
		super(from);
	}
