...
/**
 * Netcdf implementation of NeXus NXsample.
 * @author nxi
 * 
 */
public class NXsample extends NXGroup implements INXsample {
	 ...
	 */
	public NXsample(final NcDataset dataset, final NcGroup parent,
	 ...
	 *            String value
	 */
	public NXsample(final NcGroup parent, final String shortName) {
	 ...
	 * @param shortName
	 */
	// public NXsample(NcDataset dataset, Group parent, String shortName) {
	 ...
	 *            NcDataset object
	 */
	public NXsample(final Group from, final NcDataset dataset) {
		super(from, dataset);
	}
	 ...
	 *            GDM IGroup object
	 */
	public NXsample(final IGroup from) {
		super(from);
	}
