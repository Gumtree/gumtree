...
public class LdapGroupAuthenticator {
    ...
    private static Logger logger = LoggerFactory.getLogger(LdapGroupAuthenticator.class);
    /*
    ...
    public static boolean authenticate(String domain, String username, String password) throws NamingException {
