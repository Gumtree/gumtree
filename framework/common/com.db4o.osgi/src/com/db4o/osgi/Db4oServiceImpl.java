...
public class Db4oServiceImpl implements Db4oService {
	...
	private void configureReflector(Configuration config) {
		config.reflectWith(new JdkReflector(new OSGiLoader(getBundle(), new ClassLoaderJdkLoader(getClass().getClassLoader()))));
	}
	...
	private Bundle getBundle() {
		if (_bundle == null) {
			_bundle = Db4oActivator.getContext().getBundle();
		}
		return _bundle;
	}
}
